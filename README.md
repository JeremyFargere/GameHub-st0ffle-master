...
Avec la syntaxe ESM (import/export) il faut simplement ajouter `assert { type: 'json' }` à la fin de l'import.
Cela donnerait donc `import nomDeLaVariable from './chemin/vers/leFichier.json' assert { type: 'json' }`
</details>
